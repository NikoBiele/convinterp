...
derivatives of Runge's function. convinterp evaluates derivatives exactly from the kernels'
...
zero there, together with all lower integrals. convinterp evaluates integrals exactly from the
kernels' polynomial pieces; SciPy's cubic spline and NumPy's Chebyshev series are integrated
